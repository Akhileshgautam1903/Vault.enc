    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          <DialogHeader>
            <DialogTitle className="text-3xl font-serif">Form</DialogTitle>
            <DialogDescription>
          ...
          <FieldGroup>
            ...
            <Field data-invalid={error.site}>
              <FieldLabel htmlFor="site" className="text-xl font-serif">
            ...
            <Field data-invalid={error.username}>
              <FieldLabel htmlFor="username" className="text-xl font-serif">
              ...
              {error.username && <FieldError>Username is required.</FieldError>}
            </Field>

            {/* password input with peek feature */}
            <Field data-invalid={error.password}>
              <FieldLabel htmlFor="password" className="text-xl font-serif">
            ...
            <Field>
              <FieldLabel htmlFor="notes" className="text-xl font-serif">
                Notes (Optional)
              </FieldLabel>
              <InputGroup>
                <InputGroupTextarea
          ...
          <DialogFooter>
            <Button type="submit" className="text-lg font-serif">
              Save changes
            </Button>
            <DialogClose asChild>
              <Button variant="outline" className="text-lg font-serif">
                Cancel
              </Button>
            </DialogClose>
          </DialogFooter>
